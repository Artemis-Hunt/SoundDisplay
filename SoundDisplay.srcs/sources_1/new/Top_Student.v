...
module Top_Student (
    ...
    mux muxseg0(bcdseg[0], charseg[0], watch3, sw[1], sw[9], segData[0]);
    mux muxseg1(bcdseg[1], charseg[1], watch2, sw[1], sw[9], segData[1]);
    mux muxseg2(8'b11111111, charseg[2], watch1, sw[1], sw[9], segData[2]);
    mux muxseg3(8'b11111111, charseg[3], watch0, sw[1], sw[9], segData[3]);
    ...
    mux muxFinal(customSeg, segY, segY, customFlag, sw[9], seg);
    mux muxFinal2(customAnode, anY, anY, customFlag, sw[9], an);
